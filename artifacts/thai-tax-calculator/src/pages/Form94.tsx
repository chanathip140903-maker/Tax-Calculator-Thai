              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <Controller control={form.control} name="allowances.children_1" render={({ field }) => (
                    <NumberInput label="บุตร (คนแรก/ก่อนปี 61)" value={field.value} onChangeValue={field.onChange} />
                  )}/>
                  <Controller control={form.control} name="allowances.children_2_plus" render={({ field }) => (
                    <NumberInput label="บุตร (คนที่ 2 ขึ้นไป)" value={field.value} onChangeValue={field.onChange} />
                  )}/>
                </div>
              </div>
            </FormSection>
